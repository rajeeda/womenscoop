...
<section class="inner-header">
	...
	<section id="Introduction" class="sec-padding about-content full-sec">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 col-md-12">
					<div class="container">
						<div class="sec-title">
							<h3>The Story of Sri Lanka Women’s Services Development Cooperative Society Limited</h3>
	...
	<section class="home-serivce sec-padding">
		<div class="container">
			...
			<div class="row mt_30">
								...
								<center>
									<div class="sec-title colored"><h3 class=" mb_20"></span><b>Our Vision</b></h3>
								<span class="decor"><span class="inner"></span></div>
	                    		<p class="">Upliftment of living standards of membership on the basic of principles in Co-Operative movement</p>
	                    		</center>
	                    	
								<center><div class="sec-title colored"><h3 class="mb_20"><b>Our Mission</b></h3>
