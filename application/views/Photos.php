    ...
    <section class="gallery-section p_0">
        ...
        <div class="clearfix">       
            ...
            <div class="image-box">
                ...
                <figure class="image"><a href="<?php echo base_url(); ?>upload_images/Gallary/<?=$value->image_name;?>" class="lightbox-image"><img src="<?php echo base_url(); ?>upload_images/Gallary/<?=$value->image_name;?>" alt=""></a></figure>
                    <a href="<?php echo base_url(); ?>upload_images/Gallary/<?=$value->image_name;?>" class="" title="<?=$value->catagary;?>"></a>
                </div>
            </div>
            <?php }}?>
