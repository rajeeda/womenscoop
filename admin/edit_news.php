...
$news = News :: GetNews($_REQUEST['news_id']);
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Edit News Details</h3></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/newscontroler.php?mode=edit_news" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="80%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              
              <tr>
                <td width="4%">&nbsp;</td>
                <td colspan="3"><div id="error"><h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'News.message.php'); ?></h6>
              ...
              <tr>
                ...
                <td width="1%">:</td>
                <td><input name="txt_news_name" type="text" id="txt_news_name" size="60" value="<?php echo $news['news_name']; ?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Location / Country</td>
                <td>&nbsp;</td>
                <td><input name="txt_location" type="text" id="txt_location" size="50" value="<?php echo $news['location_name']; ?>" />          &nbsp; &nbsp; &nbsp;
                  <select name="cmb_countryName" id="cmb_countryName">
                    ...
                    <?php 
						...
						?>
                    <option value="<?php echo $row['value']['country_id'];?>" <?php if($row['value']['country_id'] == $news['country_id']){echo "selected=\"selected\" ";}?>/>                  
              ...
              <tr>
                ...
                <td>:</td>
                <td><label>
                  <img src="../upload_images/News_images/thumb/<?php echo $news['news_img']; ?>" />
                  <input name="hdn_news_img" type="hidden" id="hdn_news_img" value="<?php echo $news['news_img'];?>" /><input type="file" name="up_news_image" id="up_news_image" />
                  <br />
                  <font size="2" face="Verdana, Arial, Helvetica, sans-serif">(File 
                Types : .jpg / .gif</font>)                </label></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Add  Date</td>
                <td>:</td>
                <td><input name="news_date" type="text" id="news_date" size="20" value="<?php echo $news['news_date']; ?>" />                <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.form1.news_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="date_calander/calbtn.gif" width="34" height="22" border="0" alt=""></a>
                  </td>
              </tr>
...
$oFCKeditor->Value = html_entity_decode (stripslashes ($news['description']));
$oFCKeditor->Create() ;
?></td>
              </tr>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td><div align="right">
                  <input name="btn_add" type="submit" class="button" value="     Edit    " id="btn_add" /> 
                  <input name="btn_cancel" type="button" class="button" value="   Cancel   " onclick="window.location.href='news.php'" id="btn_cancel" />
                </div></td>
              </tr>
            </table>
          </form></td>
