...
$pub_type = Publication :: GetPublicationtype($_REQUEST['pub_type_id']);
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table width="330" border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td width="61"><div align="center"><a href="publication_type.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/categories.png',1)"><img src="images/categories.png" alt="User Manager" name="Image5" width="48" height="48" border="0" id="Image5" /></a><br />
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Update  Publication Type</h3></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/publication_type_controler.php?mode=edit_pub_type">
            <div class="container">
              <div class="row">
                <h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'publication_type.message.php'); ?><input type="hidden" name="hdn_pub_type_id" id="hdn_pub_type_id" value="<?php echo $pub_type['publication_cat_id'];?>" /></h6>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="public_cat_type" type="text" class="login_text" id="public_cat_type"  value="<?php echo $pub_type['pub_cat_name'];?>"/></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><textarea name="pub_desc" cols="30" rows="4" class="login_text" id="pub_desc"><?php echo $pub_type['description'];?></textarea></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><img src="../upload_images/Publication/thumb/<?php echo $pub_type['pub_cat_image'];?>" />
                        <input type="hidden" name="hdn_pub_type_img" id="hdn_pub_type_img" value="<?php echo $pub_type['pub_cat_image'];?>" />
                    <input name="pub_cat_image" type="file" class="login_text" id="pub_cat_image" /></div>
                </div>
              </div>
            </br>
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><input name="btn_add" type="submit" class="button" value="     Edit      " id="btn_add" /></div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left">
