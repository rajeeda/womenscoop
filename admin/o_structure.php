...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="38%"><div id="content"><table width="323" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td width="57"><div align="center"><a href="o_structure.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/impressions.png',1)"><img src="images/impressions.png" alt="User Manager" name="Image5" width="48" height="48" border="0" id="Image5" /></a><br />
                  <span class="txt_ash">Organizational Structure</span> </div></td>
              ...
              Edit Organizational Structure </div></td>
            </tr>
          </table>
    </div></td>
  </tr>
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td width="100%" class="adminlist" bgcolor="#d8d8d8"><h3>Edit Organizational Structure</h3></td>
          </tr>
        <tr>
          <td height="169" valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/award_controler.php?mode=editostructure">
            <div class="container">
              <div class="row">
            ...
            <?php 
        $ostructure =Award::organizationalstructure();
      ...
      ?>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><img src="../assets/img/causes/<?php echo $ostructure['image'];?>" height="42" width="42"/><input name="hdn_os_flag" type="hidden" value="<?php echo $ostructure['image'];?>" />
                  <input name="up_os_flag" type="file" id="up_os_flag"/></div>
                </div>
              </div>
            </br>
            <div class="row">
                <div class="col-sm-6 text-right">
                  <div ><span class="pull-right">Description :</span></div>
                </div>
                <div class="col-sm-6 pull-left">
                  <div class=""><textarea name="os_name" id="os_name" rows="8" cols="75" value="<?php echo $ostructure['description'];?>"><?php echo $ostructure['description'];?></textarea></div>
                </div>
              </div>
              </br>
              <div class="row">
