...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td align="center" valign="middle" bgcolor="#F1F3F5" class="adminlist"><div align="center" class="style1">Add Related News</div></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/newscontroler.php?mode=uploadsnews" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="79%"  border="0" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <?php $newsfiles = News:: passnewsDocuments($_REQUEST['news_id'], 'NRN');
                        foreach ($newsfiles as $newsfile) { ?>
                          <tr>
                            <td width="16%"><div align="right">&nbsp;&nbsp;<a onclick="deleteFilesNewsAtt2('<?php echo $newsfile['file_id'];?>');" href="#"><img src="/admin/images/delete.png" width="16" height="16" /></a></div></td>
                            <td width="2%">&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td width="52%"><input name="btn_add" type="submit" class="button" value="   Add   " id="btn_add" /> <input name="Submit2" type="button" class="button" value="   Finish   " onclick="window.location.href='news.php'" /></td>
                <td width="19%">&nbsp;</td>
              </tr>
            </table>
          </form></td>
