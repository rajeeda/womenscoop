...
$mode=isset($_GET['mode'])?$_GET['mode']:'update_contact_person';
...
<script language="JavaScript" type="text/JavaScript" src="scripts/contact_person.js">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td valign="middle" bgcolor="#d8d8d8" class="adminlist"><div align="center"><h3>Edit Member Profile --&gt;&gt;Contact person</h3></div></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/membercontroler.php?mode=update_contact_memeber">
            ...
            <table width="90%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              ...
              <tr>
                <td width="5%">&nbsp;</td>
                <td colspan="4"><div id="error"><h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'member.message.php'); ?></h6></div></td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="2">
                  <?php
			$contact_person = Member::getContactPerson($member_id);
			if(count($contact_person)==0)
			{
				echo '<div id="error">No Contact Person </div>';
			}
			else
			{
				for($a=0;$a<count($contact_person);$a++)
						{
							$row=each($contact_person);
			?>
                  <table width="59%" height="20" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="3%"><img src="images/right.png" width="12" height="12" /></td>
                      <td width="86%"><?php echo $row['value']['contact_person'];?></td>
                      <td width="4%"><a onclick="show_contact_person('<?php echo $row["value"]["contact_person_id"];?>')" href="#"><img src="images/edit.gif" alt="EDIT" width="18" height="18" /></a></td>
                      <td width="7%"><a onclick="deletecontactperson('<?php echo $row["value"]["contact_person_id"];?>');" href="#"><img src="images/delete.gif" alt="DELETE" width="16" height="16" /></a></td>
                    </tr>
                  </table>
                  <?php }}?>                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td colspan="2"><strong><a onclick="show_contact_person('contactperson')" href="#">New Contact Person</a></strong></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td width="37%"><input name="btn_cancel" type="button" class="button" value="   Next&gt;&gt;   " onclick="window.location.href='edit_regulater.php?member_id=<?php echo $member_id; ?>'" id="btn_cancel" /></td>
              </tr>
              <?php ?>
            </table>
          </form></td>
