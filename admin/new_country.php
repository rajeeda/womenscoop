...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="38%"><div id="content"><table width="323" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td width="57"><div align="center"><a href="country.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/impressions.png',1)"><img src="images/impressions.png" alt="User Manager" name="Image5" width="48" height="48" border="0" id="Image5" /></a><br />
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td width="100%" class="adminlist" bgcolor="#d8d8d8"><h3>Insert New Country </h3></td>
          </tr>
        <tr>
          <td height="169" valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/country_controler.php?mode=addcountry">
            <div class="container">
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div ><span class="pull-right">Country Name :</span></div>
                </div>
                <div class="col-sm-6 pull-left">
                  <div class=""><input name="txt_country_name" type="text" id="txt_country_name" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="up_country_flag" type="file" id="up_country_flag"/></div>
                </div>
              </div>
            </br>
              <div class="row">
            ...
            <table width="90%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              ...
              <tr>
                ...
                <td colspan="2"><input name="txt_country_name" type="text" id="txt_country_name" size="50" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Country Flag</td>
                <td><div align="center">:</div></td>
                <td width="35%"><input name="up_country_flag" type="file" id="up_country_flag"/> </td>
                <td width="32%">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td colspan="2"><input name="btn_add" type="submit" class="button" value="    Add    " id="btn_add" />
