    ...
    <td><div id="content"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5"><table width="100%"  border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td><div id="error"><h6 style="color:#A52A2A"><?php require_once('messages/user.message.php'); ?></h6></div></td>
            </tr>
            <tr>
              <td></td>
            </tr>
            <tr>
              <td><a href="newuser.php" class="link1"><strong>Create new user</strong></a> </td>
            </tr>
            <tr>
              <td><?php 
				if(isset($_GET['pa'])){
...
else
{
	...
	else
	{
		...
		$results = User::GetAll($query);
?>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
 
 <tr>
   <td width="22%" height="35" align="left" class="grid_alternative_row">Total number of users - <?php echo $numrows;?></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  <tr class="grid_heading" bgcolor="#d8d8d8">
    <td width="23%" height="25" class="adminlist" style="padding-left:5px; font-weight: bold;">User</td>
    <td width="30%" class="adminlist" style="padding-left:5px; font-weight: bold;">Email</td>
    <td width="25%" class="adminlist" style="padding-left:5px; font-weight: bold;">Active</td>
...
?>
  <tr class="grid_alternative_row">
    <td height="18" style="padding-left:5px;"><?php echo $row["value"]["userName"];?></td>
    ...
    <td style="padding-left:5px;"><?php echo $row["value"]["reg_date"];?></td>
    <td style="padding-left:5px;"><a href="edituser.php?uid=<?php echo $row["value"]["adminId"];?>"><img src="images/edit.gif" alt="Edit" border="0"></a> <a onclick="deleteuser('<?php echo $row["value"]["adminId"];?>');" href="#" ><img src="images/delete.gif" alt="Delete" border="0"></a></td>
    </tr>
<?php
}//end for loop
?>
...
<tr>
  <td colspan="5"><a href="newuser.php"><strong>Create new user</strong></a></td>
</tr>
</table>
<?php
} //end else 
