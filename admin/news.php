...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td width="89"><div align="center"><img src="images/massemail.png" width="48" height="48" /><br />
              News</div></td>
            </tr>
          </table></div></td>
  </tr>
  ...
  <tr>
    <td><div id="content"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5">
          <form action="controlers/newscontroler.php?mode=homepage" method="post" enctype="multipart/form-data" name="form1" id="form1">
          
          
          <table width="100%"  border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td><h6 style="color:#A52A2A"><?php require_once('messages/News.message.php'); ?></h6></td>
            </tr>
            <tr>
              <td><a href="new_news.php" class="link1"><strong>Insert News</strong></a></td>
            </tr>
            <tr>
              <td>
			  <?php 
			  ...
			  if(isset($_GET['limit'])){
				...
				$query = "SELECT n.*,C.country_name  FROM news AS n,country AS C WHERE n.country_id=C.country_id ";
					
				$numrows = News::GetAll($query);
				...
				else
				{
					...
					else
					{
						...
						$results = News ::GetAll($query);
			?>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
 
 <tr>
   <td width="22%" height="35" align="left" class="grid_alternative_row">Total number of news - <?php echo $numrows;?></td>
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  <tr class="grid_heading" bgcolor="#d8d8d8">
    <th width="35%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;"><span class="gridheadings" style="padding-left:5px; font-weight: bold;">News  Name</span></th>
    <th width="9%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;"><span class="gridheadings" style="padding-left:5px; font-weight: bold;"> Date</span></th>
    <th width="10%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Country</th>
    <th width="20%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;"><span style="padding-left:5px; font-weight: bold;">Location</span></th>
    <th width="10%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Home Page</th>
...
?>
  <tr <?php if(($a+1)%2==0){echo "class='table_row_color'";} else{echo "class='grid_alternative_row'";}?>>
    <td height="27" valign="middle" style="padding-left:5px;"><?php echo $row["value"]["news_name"];?></td>
    <td height="18" valign="middle" style="padding-left:5px;"><?php echo $row["value"]["news_date"]; ?></td>
    <td valign="middle" style="padding-left:5px;"><?php echo $row["value"]["country_name"];?></td>
    <td valign="middle" style="padding-left:5px;"><?php echo $row["value"]["location_name"];?></td>
    <td valign="middle" style="padding-left:5px;"><?php if($row["value"]["news_home"]==1){ ?> <input type="checkbox" name="checkbox" id="checkbox" checked="checked" onchange="UpdateNewsHome('<?php echo $row["value"]["news_id"];?>','0');" /><?php }else{?><input type="checkbox" name="checkbox" id="checkbox" onchange="UpdateNewsHome('<?php echo $row["value"]["news_id"];?>','1');" /><?php }?></td>
    <td width="2%" valign="middle" style="padding-left:5px;"><a href="edit_news.php?news_id=<?php echo $row["value"]["news_id"];?>"><img src="images/edit.gif" alt="Edit" border="0"></a></td>
    <td width="14%" valign="middle" style="padding-left:5px;">
   		 <a onclick="deleteNews('<?php echo $row["value"]["news_id"];?>');" href="#" ><img src="images/delete.gif" alt="Delete" border="0" /></a>    </td>
  </tr>
<?php
}//end for loop
?>
...
<tr>
  <td colspan="7"><a href="new_news.php"><strong>Insert News</strong></a></td>
</tr>
</table>
<?php
} //end else 
