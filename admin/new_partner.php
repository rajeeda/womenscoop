...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        ...
        <tr>
          <td height="169" valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/Testimonials_controler.php?mode=addpartners">
            <div class="container">
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div ><span class="pull-right">Partner Name :</span></div>
                </div>
                <div class="col-sm-6 pull-left">
                  <div class=""><input name="txt_partner_name" type="text" id="txt_partner_name" /></div>
                </div>
              </div>
            </br>
              <div class="row">
                ...
                <div class="col-sm-6 pull-left">
                  <div class=""><input name="txt_partner_url" type="text" id="txt_partner_url" /></div>
                </div>
              </div>
              </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="up_partner_logo" type="file" id="up_partner_logo"/></div>
                </div>
              </div>
            </br>
              <div class="row">
