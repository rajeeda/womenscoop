...
$pageData = Page::GetContent($_GET[page_id],$_GET['lang']);
?>
...
<body onload="MM_preloadImages('images/frontpage2.png','images/addedit2.png')">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><table border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><div align="center"><a href="page_manager.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/addedit2.png',1)"><img src="images/addedit.png" alt="Page Content Manager" name="Image5" width="48" height="48" border="0" id="Image5" /></a><br />
                  <span class="txt_ash">Page Content Managaer</span> </div></td>
              <td><div align="center"><img src="images/icon_right_arrow.png" width="20" height="20" /><img src="images/icon_right_arrow.png" width="20" height="20" /></div></td>
              <td><img src="images/rename_f2.png" width="48" height="48" /><br />
                Edit Page </td>
            </tr>
          </table></td>
  </tr>
  ...
  <tr>
    <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5"><?php if($pageData==''){ echo '<div id="error">Invalid Operation!</div>';}else{?><form id="form1" name="form1" method="post" action="controlers/pagecontroler.php?mode=update">
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="9%" valign="top">Page Title: </td>
                <td width="91%"><input name="title" type="text" id="title" value="<?php echo html_entity_decode (stripslashes ($pageData['page_title_'.$_GET['lang']]));?>" /></td>
                </tr>
              <tr>
...
$oFCKeditor->Value = html_entity_decode (stripslashes ($pageData['content_'.$_GET['lang']]));
$oFCKeditor->Create() ;
?></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="page_id" type="hidden" id="page_id" value="<?php echo $_GET['page_id'];?>" />
