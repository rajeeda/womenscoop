...
switch($msg)
{
	...
	case '1':
	$display_msg = "Please enter a Country Name information";
	break;
	
	case '2':
	$display_msg = "Please enter a category description";
	break;
	
	case '3':
	$display_msg = "Re-enter Country ......";
	break;
		
	case '4':
	$display_msg = "Country Name already exists";
	break;

	case '5':
	$display_msg = "New Country Added";
	break;

	case '6':
	$display_msg = "Country creating new country";
	break;		
	
	case '7':
	$display_msg = "Country information updated";
	break;	
	
	case '8':
	$display_msg = "Error updating Country information";
	break;	
	
	case '9':
	$display_msg = "Country Information deleted";
	break;	
	...
	case '11':
	$display_msg = "New Country Profile Added";
	break;
	
	case '12':
	$display_msg = "Error creating new country Profile";
	break;		
	
	case '13':
	$display_msg = "Error Loading Country ID";
	break;
	
	case '14':
	$display_msg = "Country Profile Details Already exists";
	break;
	...
	case '17':
	$display_msg = " Error Loading Country Flag ";
	break;
