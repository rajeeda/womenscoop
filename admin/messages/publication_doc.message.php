...
switch($msg)
{
	...
	case '1':
	$display_msg = "Please Select Publication Document Type";
	break;
	
	case '2':
	$display_msg = "Please Enter Publication Document Name";
	break;
	
	case '5':
	$display_msg = "Successful Entered New Publication Type";
	break;
	
	case '4':
	$display_msg = "Successfully Updated Publication Type";
	break;

	case '6':
	$display_msg = "Error Inserting New Publication Document";
	break;	
	
	case '7':
	$display_msg = "Deleted  Publication Document";
	break;
	
	case '8':
	$display_msg = "Cannot Delete Publication Type";
	break;
	
	case '17':
	$display_msg = "File Uploading Error";
	break;		
	
	
	
	case '9':
	$display_msg = "Publication Document Name Required";
	break;	
	
	case '10':
	$display_msg = "Enter Attachment Details";
	break;	
