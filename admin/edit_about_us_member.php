        ...
        <tr>
          ...
          <form name="form1" id="form1" method="post" action="controlers/about_us_member_controler.php?mode=edit_member_reg">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td colspan="5" class="adminlist" bgcolor="#d8d8d8"><h3>New User Profile</h3></td>
                </tr>
              <tr>
                <td width="10%">&nbsp;</td>
                <td colspan="4"><div id="error"><h6 style="color:#A52A2A"><?php include('messages/about_us_member.message.php'); ?></h6></div></td>
                </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td colspan="2"><span id="sprytextfield2">
                  <label><span id="sprytxt_email">
                    ...
                    <span class="textfieldRequiredMsg">Email address is required.</span></span></label>
</span></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td colspan="2"><span id="sprytextfield9">
                  <label>
                    <input type="password" name="txt_old_pass" id="txt_old_pass" />
                  </label>
                </span>(If you want to re new user name and password you must type old password)</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="right"><input name="Submit" type="submit" class="button" value="Update" /></td>
                <td align="left"><input name="Submit2" type="button" class="button" value="Cancel" onclick="window.location.href='edit_about_us_member_type.php'" /></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
