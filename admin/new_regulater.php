...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td valign="middle" bgcolor="#d8d8d8" class="adminlist"><div><h3>New Member Profile --&gt;&gt;Regulator</h3></div></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/membercontroler.php?mode=add_regulator&member_id=<?php echo $member_id;?>">
          <div class="container">
              <div class="row">
        ...
        ?>
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">Regular Member Name :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_reg_name" type="text" id="txt_reg_name" size="50" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">Regular Member Description :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><textarea name="txt_reg_des" cols="40" id="txt_reg_des"></textarea></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                ...
                <div class="col-sm-6">
                  <input name="txt_add" type="text" id="txt_add" size="40" /><input type="hidden" name="hdn_member_id" id="hdn_member_id" value="<?php echo $member_id;?>" /></div>
                </div>
              ...
              <div class="row ">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><span class="pull-left"><input name="btn_add" type="submit" class="button" value="     Add     " id="btn_add" onclick="reload();" /></span></div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left">
                    <span class=""><input name="btn_cancel" type="button" class="button" value="   Next   " onclick="window.location.href='member_staff.php?member_id=<?php echo $member_id; ?>'" id="btn_cancel" /></span></div>
                </div>
              </div>
