...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table width="263" border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/hoteladdcontroler.php?mode=addcat">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td><div id="error">
                  <?php require_once('messages/folder.message.php'); ?>
                </div></td>
              </tr>
              <tr>
                <td><a href="new_board_member_folder.php" class="link1 style1"><strong>Create New Folder</strong></a> </td>
              </tr>
              <tr>
                <td height="171"><?php 
			if(isset($_GET['pa'])){
...
$query = "select * from board_member_folders";
...
if ($numrows==0)
{
	echo $err = "<div id=error>No Folders are available</div>"; 
}
else
{
	...
	else
	{
		...
		$results = BoardMemberFolder::GetAll($query);
...
?>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                      <tr class="grid_heading" bgcolor="#d8d8d8">
                        ...
                        <th width="20%" height="25" class="adminlist" style="padding-left:5px; font-weight: bold;">Folder Name</th>
...
?>
                      <tr <?php if(($a+1)%2==0){echo "class='table_row_color'";} else{echo "class='grid_alternative_row'";}?>>
                        ...
                        <td height="27" valign="middle" style="padding-left:5px;"><?php echo $row["value"]["folders_name"];?></td>
                        <td valign="middle" style="padding-left:5px;">&nbsp;</td>
                        ...
                        <td valign="middle" style="padding-left:5px;"><a href="edit_board_member_folder.php?pub_type_id=<?php echo $row["value"]["folder_id"];?>"><img src="images/edit.gif" alt="Edit" border="0" /></a>  &nbsp;&nbsp;&nbsp;<a onclick="deleteboardmemfolder('<?php echo $row["value"]["folder_id"];?>');" href="#" ><img src="images/delete.gif" alt="Delete" border="0" /></a></td>
                      </tr>
                      <?php
}//end for loop
?>
                      ...
                      <tr>
                        <td colspan="7"><a href="new_board_member_folder.php"><strong>Create New Folder</strong></a></td>
                      </tr>
                    </table>
                  <?php
} //end else 
