...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Update Member Profile -&gt;&gt; Contact Details</h3></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/membercontroler.php?mode=update_contact&member_id=<?php echo $member_id;?>">
          <?php
            ...
            <table width="80%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              ...
              <tr>
                ...
                <td width="2%">:</td>
                <td width="73%"><label>
                  <input name="txt_Street1" type="text" id="txt_Street1" value="<?php echo $member['street1'];?>" size="50" />
                </label></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Street 2</td>
                <td>:</td>
                <td><input name="txt_Street2" type="text" id="txt_Street2" size="50" value="<?php echo $member['street2'];?>" /></td>
              </tr>
              <tr>
                <td height="31">&nbsp;</td>
                <td>City </td>
                <td>:</td>
                <td><input name="txt_City" type="text" id="txt_City" size="40" value="<?php echo $member['city'];?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Province </td>
                <td>:</td>
                <td><label>
                <input name="txt_Province" type="text" id="txt_Province" value="<?php echo $member['province'];?>" size="40" />
                </label></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Postal Code</td>
                <td>:</td>
                <td><input name="txt_Postal_Code" type="text" id="txt_Postal_Code" size="25" value="<?php echo $member['postal_code'];?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Phone number</td>
                <td>:</td>
                <td><label>
                  <input name="txt_Phone_No" type="text" id="txt_Phone_No" size="25" value="<?php echo $member['phone_no'];?>" />
                </label></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td>:</td>
                <td><label>
                  <input name="txt_Fax_No" type="text" id="txt_Fax_No" value="<?php echo $member['fax_no'];?>" size="25" />
                </label></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input name="btn_add" type="submit" class="button" value="   Update   " id="btn_add" onclick="reload();" />
                <input name="btn_skip" id="btn_skip" type="button" class="button" value="    Skip     " onclick="window.location.href='edit_member_contactPerson.php?member_id=<?php echo $member['member_id'];?>'" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><!--	<input name="btn_cancel" type="button" class="button" value="Cancel" onclick="window.location.href='new_member_basic_details.php'" id="btn_cancel" />  -->               </td>
              </tr>
              <?php }?>
            </table>
          </form></td>
