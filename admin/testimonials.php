  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table width="242" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><div align="center"><a href="testimonials.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('country','','images/Office.png',1)"><img src="images/Office.png" alt="Country" name="country" width="48" height="48" border="0" id="country" /></a><br />
                  <span class="txt_ash">Testimonials</span> </div></td>
              <td>&nbsp;</td>
              </tr>
          </table>
    </div></td>
        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/country_controler.php?mode=addcat">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                <td><a href="new_testy.php" class="link1"><strong>Insert new testimonial</strong></a> </td>
              </tr>
              <tr>
                <td><?php 
 				if(isset($_GET['pa'])){
...
if ($numrows==0)
{
	echo $err = "<div id=error>No Testimonial Details are available</div>"; 
}
else
{
...
?>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                      <tr class="grid_heading" bgcolor="#d8d8d8">
                        ...
                        <th width="15%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Writter</th>
                        <th width="42%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Testinmonial</th>
...
?>
                      <tr <?php if(($a+1)%2==0){echo "class='table_row_color'";} else{echo "class='grid_alternative_row'";}?>>
                        <td height="26" style="padding-left:5px;"><?php echo $row["value"]["t_heading"];?></td>
                        <td style="padding-left:5px;"><?php echo $row["value"]["t_writter"]; ?></td>
                        <td style="padding-left:5px;"><?php echo $row["value"]["t_message"]; ?></td>
                        <td style="padding-left:5px;"><a href="edittesty.php?testy_id=<?php echo $row["value"]["testimonial_ref"];?>"><img src="images/edit.gif" alt="Edit" border="0" /></a>  &nbsp;&nbsp;&nbsp;<a  onclick="deletetesy('<?php echo $row["value"]["testimonial_ref"];?>');"  href="#" ><img src="images/delete.gif" alt="Delete" border="0" /></a></td>
                      </tr>
                      <?php
}//end for loop
?>
