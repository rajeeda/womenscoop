...
$core_id	=	isset( $_GET['core_id'])?$_GET['core_id']:$_GET['core_id'];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Update Core Values</h3></td>
          </tr>
        <tr>
          <td valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/Core_val_controler.php?mode=editvalue">
          <?php 
		  	$core_val= Core_val::Getcore_data($core_id);
		  ?>
      <div class="container">
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><input type="hidden" name="hdn_core_id" id="hdn_core_id" value="<?php echo $core_val['core_id'];?>" />Core Value Title :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><input name="core_title" type="text" id="core_title" value="<?php echo $core_val['title'];?>" size="50" /></div>
                </div>
              </div>
            </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><textarea name="core_name" id="core_name" rows="8" cols="75" value="<?php echo $core_val['description'];?>"><?php echo $core_val['description'];?></textarea></div>
                </div>
              </div>
            </br>
              <div class="row">
