  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table width="242" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><div align="center"><a href="award.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('award','','images/impressions.png',1)"><img src="images/award.png" alt="Awards" name="awards" width="48" height="48" border="0" id="awards" /></a><br />
                  <span class="txt_ash">Awardees</span> </div></td>
              <td>&nbsp;</td>
              </tr>
          </table>
    </div></td>
        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/country_controler.php?mode=addcat">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td><div id="error">
                  <h6 style="color:#A52A2A"><?php require_once('messages/award.message.php'); ?></h6>
                </div></td>
              </tr>
              <tr>
                <td><a href="new_award.php" class="link1"><strong>Insert new Award</strong></a> </td>
              </tr>
              <tr>
                <td><?php 
 				if(isset($_GET['pa'])){
...
$query = "SELECT awardees_category.category_name,awards.award_id,awards.award_year,awards.awader,awards.active,country.country_name FROM
awards
...
?>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                      <tr class="grid_heading" bgcolor="#d8d8d8">
                        <th width="15%" height="35" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Year</th>
                        <th width="20%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Award Name</th>
                        <th width="33%" height="35" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Awardees</th>
                        <th width="15%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Country</th>
                        <th width="10%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Active</th>
                        <th width="17%" height="35" class="adminlist" align="left" style="padding-left:5px;"><strong>Action</strong></th>
                      </tr>
                      <?php
...
?>
                      <tr <?php if(($a+1)%2==0){echo "class='table_row_color'";} else{echo "class='grid_alternative_row'";}?>>
                        <td height="26" style="padding-left:5px;"><?php echo $row["value"]["award_year"];?></td>

                        <td style="padding-left:5px;"><?php echo $row["value"]["category_name"]; ?></td>
                        <td height="26" style="padding-left:5px;"><?php echo $row["value"]["awader"];?></td>
                        <td style="padding-left:5px;"><?php echo $row["value"]["country_name"]; ?></td>
                        <td valign="middle" style="padding-left:5px;">
                          <?php if($row["value"]["active"]=="1"){?><img src="images/tick.png" alt="Edit" border="0"><?php }else{?><img src="images/publish_x.png" alt="Edit" border="0"><?php } ?></td>
                        
                        <td style="padding-left:5px;"><a href="edit_award.php?award_id=<?php echo $row["value"]["award_id"];?>"><img src="images/edit.gif" alt="Edit" border="0" /></a>  &nbsp;&nbsp;&nbsp;<a  onclick="deleteawards('<?php echo $row["value"]["award_id"];?>');"  href="#" ><img src="images/delete.gif" alt="Delete" border="0" /></a></td>
                      </tr>
                      <?php
}//end for loop
?>
                      ...
                      <tr>
                        <td colspan="5"><span class="style1"><a href="new_award.php" class="link1">Insert  new Award</a><a href="newcategory.php"></a></span></td>
                      </tr>
                    </table>
                  <?php
} //end else 
