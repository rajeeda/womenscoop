...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table width="330" border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td width="40"><div align="center"><img src="images/icon_right_arrow.png" width="20" height="20" /><img src="images/icon_right_arrow.png" width="20" height="20" /></div></td>
              <td width="109"><div align="center"><a href="#"><img src="images/module.png" width="48" height="48" /></a><br />
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><span class="button_fonts"><h3>Insert Board Member Folder</h3></span></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/folder_controler.php?mode=addpub_type">
            <table width="90%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              
              <tr>
                <td colspan="4"><div id="error"><h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'folder.message.php'); ?></h6>
                </div></td>
                </tr>
              <tr>
                <td colspan="4">&nbsp;</td>
              ...
              <tr>
                <td colspan="4" valign="top"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td width="206" height="37" class="login_text">Folder Name</td>
                    <td width="442"><input name="public_cat_type" type="text" class="login_text" id="public_cat_type" /></td>
                  </tr>
                  <tr>
                    <td height="76" valign="top">Folder  Description</td>
                    <td valign="top"><textarea name="pub_desc" cols="30" rows="4" class="login_text" id="pub_desc"></textarea></td>
                  </tr>
                  <tr>
                    <td height="31"> Image</td>
                    <td><input name="pub_cat_image" type="file" class="login_text" id="pub_cat_image" /></td>
                  </tr>
                  <tr>
                    <td>Active</td>
                    <td><select name="cmb_act" id="cmb_act">
