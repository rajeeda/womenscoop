...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>New Category Information</h3></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/categorycontroler.php?mode=addcat">
            <table width="75%"  border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                ...
                <td width="2%">:</td>
                <td width="70%">
				<input name="category" type="text" class="txt_boxes" id="category" size="50" />				</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Description</td>
                <td>:</td>
                <td><textarea name="description" cols="30" rows="3" class="txt_boxes" id="description"></textarea></td>
              </tr>             
              <tr>
                <td>&nbsp;</td>
                <td>Active</td>
                <td>:</td>
                <td>
				<select name="active" class="txt_boxes" id="active">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input name="Submit" type="submit" class="button" value="Add" /> <input name="Submit2" type="button" class="button" value="Cancel" onclick="window.location.href='category_manager.php'" /></td>
              </tr>
            </table>
          </form></td>
        </tr>
