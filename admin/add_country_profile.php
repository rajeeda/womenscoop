...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr>
          <td width="100%" bgcolor="#d8d8d8" class="adminlist"><h3>Insert Country Profile </h3></td>
          </tr>
        <tr>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div align="center">
                        ...
                        <?php } echo $country['country_name'];?><input type="hidden" name="country_id" id="country_id" value="<?php echo $_REQUEST['countryid']; ?>" /><div height="29" bgcolor="#F1F3F5" class="login_text"></div></div>
                </div>
              </div>
            </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_population_milion" type="text" class="login_text" id="txt_population_milion" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_population_growth_per_year" type="text" class="login_text" id="txt_population_growth_per_year" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_gdp_bilion" type="text" class="login_text" id="txt_gdp_bilion" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_gni" type="text" class="login_text" id="txt_gni" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_exchange_rate" type="text" class="login_text" id="txt_exchange_rate" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_cu_present" type="text" class="login_text" id="txt_cu_present" /></div>
                </div>
              </div>
            </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left">
                    <input name="btn_cancel" type="button" class="button" value="   Cancel   " onclick="window.location.href='new_country.php'" id="btn_cancel" /></div>
                </div>
              </div>
            </div>
            <!--
