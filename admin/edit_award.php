...
$award_id	=	isset( $_GET['award_id'])?$_GET['award_id']:$_GET['id'];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Edit Awardees</h3></td>
          </tr>
        <tr>
          <td valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/award_controler.php?mode=editaward">
          <?php 
		  	$award =Award::GetAwards_data($award_id);
      ...
      <div class="container">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><input type="hidden" name="hdn_awd_id" id="hdn_awd_id" value="<?php echo $award['award_id'];?>" />Award year :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left">
          ...
          {?>
                  <option value="<?php echo $y;?>" <?php if($y==$award['award_year']){?>selected="selected"<?php }?>><?php echo $y;?></option>
                  <?php 
          }
        ?>
                </select>     </div>
                ...
                <div class="col-sm-6">
                  <div class="pull-left">
                      <select id="txt_country_name" name="txt_country_name">
                          <option value="<?php echo $award['country'];?>"><?php echo $award['country_name'];?><option>
                            <?php 
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><select id="txt_catagory_name" name="txt_catagory_name">
                          <option value="<?php echo $award['category_id'];?>"><?php echo $award['category_name'];?></option>
                            <?php 
            ...
            ?>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_awd_name" type="text" id="txt_awd_name" value="<?php echo $award['awader'];?>" size="50" /></div>
                </div>
              </div>
            </br>
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left">
                    <input name="btn_cancel" type="button" class="button" value="   Cancel    " onclick="window.location.href='award.php?award_id=<?php echo $award['award_id'];?>'" id="btn_cancel" /></div>
                </div>
              </div>
            </div>
