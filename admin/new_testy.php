...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>New Testimonials</h3></td>
          </tr>
        <tr>
          <td valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/Testimonials_controler.php?mode=newtesy">
      ...
      <div class="container">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><input type="hidden" name="hdn_testy_id" id="hdn_testy_id" value="" />Testimonial header :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left">
                  <input name="txt_testy_name" type="text" id="txt_testy_name" value="" size="50" /> </div>
                </div>
              </div>
              </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_tesy_writer" type="text" id="txt_tesy_write" value="" size="50" /></div>
                </div>
              </div>
              </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><textarea name="testy_name" id="testy_name" rows="8" cols="75" value=""></textarea></div>
                </div>
              </div>
            </br>
              <div class="row">
