...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><div align="center"><img src="images/icon_right_arrow.png" width="20" height="20" /><img src="images/icon_right_arrow.png" width="20" height="20" /></div></td>
              <td><div align="center"><img src="images/addusers.png" width="48" height="48" /><br />
                  Add User </div></td>
            </tr>
          </table>
    </div></td>
  ...
  <tr>
    <td><div id="content"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/usercontroler.php?mode=rgister">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                <td width="10%">&nbsp;</td>
                <td colspan="3"><div id="error"><h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'user.message.php'); ?></h6></div></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td width="18%">Email</td>
                <td width="2%">:</td>
                <td width="70%"><input name="email" type="text" id="email" size="50" required/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>User Name</td>
              ...
              <tr>
                ...
                <td>Password</td>
                <td>:</td>
                <td><input name="pass" type="password" id="pass" size="20" required/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>Re-Password</td>
                <td>:</td>
                <td><input name="re_pass" type="password" id="re_pass" size="20" required/></td>
              </tr>
