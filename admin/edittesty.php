...
require_once(ADMIN_PATH.'classes/Testimonials.class.php');

$testy_id	=	isset( $_GET['testy_id'])?$_GET['testy_id']:$_GET['testy_id'];
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="36%"><div id="content">
      <table width="343" border="0" cellpadding="2" cellspacing="2">
        <tr>
          ...
          <td width="63"><div align="center"><a href="testimonial.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/Office.png',1)"><img src="images/Office.png" alt="User Manager" name="Image5" width="48" height="48" border="0" id="Image5" /></a><br />
                  <span class="txt_ash">Testimonial</span> </div></td>
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Edit Testimonials</h3></td>
          </tr>
        <tr>
          <td valign="top" bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/Testimonials_controler.php?mode=edittesy">
          <?php 
		  	$testy =Testimonials::GetTesty_data($testy_id);
      ...
      <div class="container">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><input type="hidden" name="hdn_testy_id" id="hdn_testy_id" value="<?php echo $testy['testimonial_ref'];?>" />Testimonial header :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left">
                  <input name="txt_testy_name" type="text" id="txt_testy_name" value="<?php echo $testy['t_heading'];?>" size="50" /> </div>
                </div>
              </div>
              </br>
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">Testimonial writer  :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_tesy_writer" type="text" id="txt_tesy_write" value="<?php echo $testy['t_writter'];?>" size="50" /></div>
                </div>
              </div>
              </br>
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">Testimony:</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><textarea name="testy_name" id="testy_name" rows="8" cols="75" value="<?php echo $testy['t_message'];?>"><?php echo $testy['t_message'];?></textarea></div>
                </div>
              </div>
            </br>
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left">
                    <input name="btn_cancel" type="button" class="button" value="   Cancel    " onclick="window.location.href='testimonials.php'" id="btn_cancel" /></div>
                </div>
              </div>
            </div>
