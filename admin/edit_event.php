...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        ...
        <tr>
            <td colspan="4" class="adminlist" bgcolor="#d8d8d8"><h3>Edit Event Profile</h3></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/eventcontroler.php?mode=edit_event&event_id=<?php echo $event_id;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="80%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              <tr>
                <td width="10%">&nbsp;</td>
                <td colspan="3"><div id="error"><h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'event.message.php'); ?></h6></div></td>
                </tr>
              <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td width="18%">Short Description</td>
                <td width="1%">:</td>
                <td><input name="txt_short_des" type="text" id="txt_short_des" size="110" value="<?php echo $event['event_short_description'];?>" maxlength="98"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
