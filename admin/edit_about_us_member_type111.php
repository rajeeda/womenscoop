...
require_once(ADMIN_PATH.'classes/about_us_member.class.php');
        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/about_us_member_controler.php?mode=edit_type_reg">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              ...
              <tr>
                <td width="8%">&nbsp;</td>
                <td colspan="4"><div id="error"><h6 style="color:#A52A2A"><?php include(ADMIN_MESSAGES.'about_us_member.message.php'); ?></h6></div></td>
                </tr>
              <tr>
