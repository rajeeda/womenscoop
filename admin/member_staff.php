...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
       <tr>
          <td colspan="5" bgcolor="#d8d8d8"><div id="title"><h3>New Member Profile --&gt;&gt;Board of Directors</h3></div></td>
        </tr>
        <tr>
        ...
        ?>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left"><input name="txt_name" type="text" id="txt_name" size="45" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">Board Of Director :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><select name="cmb_position_no" id="cmb_position_no">
                  <option value="select">Select>></option>
                  <?php 
            for($a=1;$a<=30;$a++)
            {                  
          ...
          ?>
                ...
                <input name="txt_Position" type="text" id="txt_Position" /><input type="hidden" name="hdn_member_id" id="hdn_member_id" value="<?php echo $_GET['member_id'];?>" /></div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="pull-left">
                    <input name="btn_finish" type="button" class="button" id="btn_finish" value="  Finish  " onclick="window.location.href='member.php'" /></div>
                </div>
              </div>
