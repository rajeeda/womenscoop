...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td width="48"><div align="center"><a href="core_value.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/Icon.png',1)"><img src="images/searchtext.png" alt="User Manager" name="Image5" width="48" height="48" border="0" id="Image5" /></a><br />
              Core values</div></td>
              <td width="40"><div align="center"><img src="images/icon_right_arrow.png" width="20" height="20" /><img src="images/icon_right_arrow.png" width="20" height="20" /></div></td>
              <td width="65"><div align="center"><img src="images/menu.png" width="48" height="48" /><br />
               Update Core values</div></td>
            </tr>
          </table>
    </div></td>
  </tr>
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#d8d8d8" class="adminlist"><h3>Update new photos to core values</h3></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/Core_val_controler.php?mode=editimg">
          <?php 
        $core_val = Core_val:: GetvalueImage();
      ?>
      <div class="container">
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right"><input type="hidden" name="hdn_img_id" id="hdn_img_id" value="<?php echo $core_val['img_id'];?>" /></div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">1st Image :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><img src="../assets/img/faq/<?php echo $core_val['image1']; ?>" height="42" width="42"/><input name="hdn_img1" type="hidden" value="<?php echo $core_val['image1']; ?>" />
                  <input name="up_img1" type="file" id="up_img1"/></div>
                </div>
              </div>
            </br>
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">2nd Image :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><img src="../assets/img/faq/<?php echo $core_val['image2']; ?>" height="42" width="42"/><input name="hdn_img2" type="hidden" value="<?php echo $core_val['image2']; ?>" />
                  <input name="up_img2" type="file" id="up_img2"/></div>
                </div>
              </div>
            </br>
              ...
              <div class="row">
                <div class="col-sm-6 text-right">
                  <div class="pull-right">3rd Image :</div>
                </div>
                <div class="col-sm-6">
                  <div class="pull-left"><img src="../assets/img/faq/<?php echo $core_val['image3']; ?>" height="42" width="42"/><input name="hdn_img3" type="hidden" value="<?php echo $core_val['image3']; ?>" />
                  <input name="up_img3" type="file" id="up_img3"/></div>
                </div>
              </div>
            </br>
              <div class="row">
