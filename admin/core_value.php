  ...
  <tr>
    ...
    <td width="36%"><div id="content"><table width="242" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><div align="center"><a href="core_value.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('country','','images/Icon.png',1)"><img src="images/browser.png" alt="Country" name="country" width="48" height="48" border="0" id="country" /></a><br />
                  <span class="txt_ash">Core Value</span> </div></td>
              <td>&nbsp;</td>
              </tr>
          </table>
    </div></td>
        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/country_controler.php?mode=addcat">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td><div id="error">
                  <h6 style="color:#A52A2A"><?php require_once('messages/core.message.php'); ?></h6>
                </div></td>
              </tr>
              <tr>
                <td><a href="new_core_val.php" class="link1"><strong>Insert new title</strong></a></br> 
                <a href="new_core_images.php" class="link1"><strong>Edit Images</strong></a> </td>
              </tr>
              <tr>
                <td><?php 
 				if(isset($_GET['pa'])){
...
$query = "select * from core_value";

$numrows = Core_val::GetAll($query);
...
?>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                      <tr class="grid_heading" bgcolor="#d8d8d8">
                        <th width="33%" height="35" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Title</th>
                        <th width="55%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Description</th>
                        <th width="12%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Action</th>
                      </tr>
                      <?php
...
?>
                      <tr <?php if(($a+1)%2==0){echo "class='table_row_color'";} else{echo "class='grid_alternative_row'";}?>>
                        <td style="padding-left:5px;"><?php echo $row["value"]["title"]; ?></td>
                        <td style="padding-left:5px;"><?php echo $row["value"]["description"]; ?></td>
                        <td style="padding-left:5px;"><a href="edit_core_val.php?core_id=<?php echo $row["value"]["core_id"];?>"><img src="images/edit.gif" alt="Edit" border="0" /></a>  &nbsp;&nbsp;&nbsp;<a  onclick="deletecore_val('<?php echo $row["value"]["core_id"];?>');"  href="#" ><img src="images/delete.gif" alt="Delete" border="0" /></a></td>
                      </tr>
                      <?php
}//end for loop
?>
                      ...
                      <tr>
                        <td colspan="5"><span class="style1"><a href="new_core_val.php" class="link1">Insert  new core value</a><a href="newcategory.php"></a></span></td>
                      </tr>
                    </table>
                  <?php
} //end else 
