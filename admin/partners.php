    ...
    <td width="36%"><div id="content"><table width="242" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><div align="center"><a href="country.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('country','','images/impressions.png',1)"><img src="images/browser.png" alt="Country" name="country" width="48" height="48" border="0" id="country" /></a><br />
                  <span class="txt_ash">Development Partners</span> </div></td>
              <td>&nbsp;</td>
              </tr>
          </table>
    </div></td>
        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" action="controlers/country_controler.php?mode=addcat">
            <table width="100%"  border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td><div id="error">
                  <h6 style="color:#A52A2A"><?php require_once('messages/testimonials.message.php'); ?></h6>
                </div></td>
              </tr>
              <tr>
                <td><a href="new_partner.php" class="link1"><strong>Insert new Partner</strong></a> </td>
              </tr>
              <tr>
                <td><?php 
 				if(isset($_GET['pa'])){
...
$query = "select * from homepage_partners";
...
if ($numrows==0)
{
	echo $err = "<div id=error>No Partners Details are available</div>"; 
}
else
{
...
?>
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
                      <tr>
                        <td width="20%" height="35" align="left" class="grid_alternative_row" >Total number of Records - <?php echo $numrows;?></td>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                      <tr class="grid_heading" bgcolor="#d8d8d8">
                        <th width="33%" height="35" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Name</th>
                        <th width="30%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">Logo</th>
                        <th width="25%" align="left" class="adminlist" style="padding-left:5px; font-weight: bold;">URL</th>
                        <th width="12%" height="35" class="adminlist" align="left" style="padding-left:5px;"><strong>Action</strong></th>
                      </tr>
                      <?php
...
?>
                      <tr <?php if(($a+1)%2==0){echo "class='table_row_color'";} else{echo "class='grid_alternative_row'";}?>>
                        <td height="26" style="padding-left:5px;"><?php echo $row["value"]["partner_name"];?></td>
                        <td style="padding-left:5px;">
                        <?php if($row["value"]["partner_logo"]!=NULL){?>
                        <img src="../assets/img/team/<?php echo $row["value"]["partner_logo"]; ?>" width="40" height="17" />
                        <?php }?>
                        </td>
                        <td style="padding-left:5px;"><?php echo $row["value"]["partner_url"]; ?></td>
                        <td style="padding-left:5px;"><a href="edit_partner.php?partner_id=<?php echo $row["value"]["partner_id"];?>"><img src="images/edit.gif" alt="Edit" border="0" /></a>  &nbsp;&nbsp;&nbsp;<a  onclick="deletepartner('<?php echo $row["value"]["partner_id"];?>');"  href="#" ><img src="images/delete.gif" alt="Delete" border="0" /></a></td>
                      </tr>
                      <?php
}//end for loop
?>
                      ...
                      <tr>
                        <td colspan="5"><span class="style1"><a href="new_partner.php" class="link1">Insert  New Partner</a><a href="newcategory.php"></a></span></td>
                      </tr>
                    </table>
                  <?php
} //end else 
